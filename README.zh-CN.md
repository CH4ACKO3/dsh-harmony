<div align="center">
  ...
  <p>
    <a href="#安装"><strong>开始使用</strong></a>
    ·
    <a href="docs/usage.zh-CN.md">阅读指南</a>
    ·
    <a href="https://github.com/CH4ACKO3/dsh-harmony/issues">反馈问题</a>
  </p>
...
项目的手写实现统一使用 TypeScript。`npm run build` 会编译核心库、浏览器客户端和
安装脚本，分别生成 `lib/`、`browser-dist/` 和 `scripts/*.cjs` 发布产物；
`npm test` 还会严格检查 TypeScript E2E 测试并运行完整回归。
